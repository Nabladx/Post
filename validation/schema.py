...
class PostBase(
    BaseModel):  # extends BaseModel from Pydantic package and adds validation to the incoming request params in our different CRUD methods
    title: str
    content: str
...
class PostResponse(
    PostBase):  # in this reponse class we are defining what properties that should be sent back as part of the response
    id: int
    createdAt: datetime
    userId: int
