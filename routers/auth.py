...
@router.post("/login",
             response_model=schema.Token)  # response_model=schema.Token: validates that the response params of this api complies to schema.Token ie. token and tokenType
